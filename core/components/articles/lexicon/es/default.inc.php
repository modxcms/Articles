...
$_lang['articles.setting.notifyTwitter_notyet_desc'] = 'Publicar automáticamente un enlace a Twitter cuando se publique un Artículo.<strong> Nota: Primero debes visitar <a href="[[+authUrl]]" target="_blank">la página de autenticación para autenticar</a> Artículos a tu cuenta de Twitter</ strong>';
...
$_lang['articles.setting.commentsReplyResourceId_desc'] = 'El ID que contiene al "snippet" QuipReply, para responder a los comentarios encadenados. <strong> Esto es necesario para los comentarios encadenados. </ strong>';
