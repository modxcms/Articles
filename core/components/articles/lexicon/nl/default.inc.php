 ...
 * @package articles
 */
$_lang['articles.advanced_settings'] = 'Expert Instellingen';
$_lang['articles.all'] = 'Alles';
$_lang['articles.Artikel'] = 'Artikel';
$_lang['articles.article_alias'] = 'Alias (Permalink)';
$_lang['articles.article_content'] = 'Content';
$_lang['articles.article_create'] = 'Nieuw Artikel';
$_lang['articles.article_delete'] = 'Verwijder Artikel';
$_lang['articles.article_delete_confirm'] = 'Ben je er zeker van het geselecteerde artikel te willen verwijderen?';
$_lang['articles.article_delete_multiple'] = 'Verwijder Meerdere Artikelen';
...
$_lang['articles.article_selected_publish'] = 'Publiceer geselecteerd';
$_lang['articles.article_selected_unpublish'] = 'Depubliceer geselecteerd';
$_lang['articles.article_summary'] = 'Samenvatting';
$_lang['articles.article_tags'] = 'Tags';
$_lang['articles.article_title'] = 'Artikel Titel';
$_lang['articles.article_unpublish'] = 'Depubliceer';
$_lang['articles.articles'] = 'Artikelen';
$_lang['articles.articles_err_ns_multiple'] = 'Selecteer minstens één artikel.';
$_lang['articles.articles_import'] = 'Importeer Artikelen';
$_lang['articles.articles_manage'] = 'Beheer Artikelen';
$_lang['articles.articles_none'] = 'Nog géén artikelen!';
$_lang['articles.articles_search'] = 'Zoek Artikelen...';
$_lang['articles.articles_view'] = 'Bekijk Artikelen';
$_lang['articles.articles_write_new'] = 'Schrijf Nieuw Artikel';
$_lang['articles.author'] = 'Auteur';
$_lang['articles.categories'] = 'Categorieën';
$_lang['articles.comments'] = 'Commentaar';
$_lang['articles.comments.intro_msg'] = 'Hier kun je commentaar voor alle artikelen bekijken, beoordelen en eventueel afwijzen.';
$_lang['articles.container'] = 'Artikelen';
$_lang['articles.container_alias'] = 'Container Alias';
$_lang['articles.container_alias_desc'] = 'De web friendly URL dat gebruikt wordt om de URL van het artikel container te berekenen.';
$_lang['articles.container_create_here'] = 'Maak Artikelen Hier';
$_lang['articles.container_delete'] = 'Verwijder Artikel Containers';
$_lang['articles.container_description'] = 'Beschrijving';
$_lang['articles.container_description_desc'] = 'Een korte beschrijving van je artikel container.';
$_lang['articles.container_menutitle_desc'] = 'De titel welke gebruikt wordt in het navigatie menu.';
$_lang['articles.container_new'] = 'Nieuw Artikel Container';
$_lang['articles.container_publish'] = 'Publiceer Artikel Container';
$_lang['articles.container_settings'] = 'Container Instellingen';
$_lang['articles.container_title'] = 'Container Titel';
$_lang['articles.container_title_desc'] = 'De titel van de Artikel Container.';
$_lang['articles.container_undelete'] = 'Herstel Artikel Container';
$_lang['articles.container_unpublish'] = 'Depubliceer Artikel Container';
$_lang['articles.content'] = 'Content';
$_lang['articles.filter_ellipsis'] = 'Filter...';
$_lang['articles.import_blogger_container_err_nf'] = 'Kan geen artikel container vinden om te importeren!';
$_lang['articles.import_blogger_file'] = 'Blogger Export XML File';
$_lang['articles.import_blogger_file_desc'] = 'Selecteer de Blogger XML file die verkregen is met de Blogger export.';
...
$_lang['articles.import_modx_change_template_desc'] = 'If checked, will change the Template of the new Artikel to this Artikel Container\'s Template. Recommended to leave checked.';
...
$_lang['articles.import_modx_unpublished_desc'] = 'Als geselecteerd, importeerd ook ongepubliceerde resources.';
$_lang['articles.import_options'] = 'Importeer Opties';
$_lang['articles.import_service'] = 'Importeer vanuit';
...
$_lang['articles.publishedon'] = 'Gepubliceerd Op';
$_lang['articles.published'] = 'Gepubliceerd';
$_lang['articles.publishing_information'] = 'Informatie publiceren';
$_lang['articles.settings'] = 'Instellingen';
$_lang['articles.settings_archiving'] = 'Archieven';
$_lang['articles.settings_comments'] = 'Commentaar';
$_lang['articles.settings_comments_display'] = 'Laat zien';
$_lang['articles.settings_comments_latest'] = 'Laatste';
$_lang['articles.settings_comments_moderation'] = 'Beveiliging';
$_lang['articles.settings_comments_other'] = 'Ander';
$_lang['articles.settings_general'] = 'Algemeen';
$_lang['articles.settings_latest_posts'] = 'Laatste Posts';
...
$_lang['articles.settings_tagging'] = 'Tags';
$_lang['articles.statistics'] = 'Statistieken';
$_lang['articles.status'] = 'Status';
$_lang['articles.template'] = 'Template';
$_lang['articles.template_desc'] = 'Het Template dat de blog lijst gebruikt.';
$_lang['articles.tags'] = 'Tags (komma gescheiden)';
$_lang['articles.unpublished'] = 'Gedepubliceerd';
$_lang['none'] = 'Geen';
...
$_lang['articles.setting.articleTemplate_desc'] = 'Het standaard template voor artikelen.';
$_lang['articles.setting.tplArticleRow'] = 'Artikel regel Chunk';
$_lang['articles.setting.tplArticleRow_desc'] = 'De Chunk to use when displaying Articles on the front page or archive pages.';
...
$_lang['articles.setting.latestPostsTpl_desc'] = 'The Chunk to use for each Latest Artikel.';
...
$_lang['articles.setting.notifyTwitter_desc'] = 'Automatically post link to Twitter when Artikel is published.';
$_lang['articles.setting.notifyTwitter_notyet_desc'] = 'Automatically post link to Twitter when Artikel is published. <strong>Note: You must first visit <a href="[[+authUrl]]" target="_blank">the authentication page</a> to authenticate Articles to your Twitter account!</strong>';
...
$_lang['articles.setting.commentsThreaded_desc'] = 'Whether or not this thread can have threaded comments. Threaded comments allow users to comment on comments, increasing the level of indentation. Non-threaded comments allow users to comment only on the parent Artikel, not on the comments.';
...
$_lang['articles.setting.commentsSortDir'] = 'Reacties sorteervolgorde';
$_lang['articles.setting.commentsSortDir_desc'] = 'De sorteervolgorde voor reacties ("DESC" voor laatste reactie bovenaan, of "ASC" voor eerste reactie bovenaan)';
...
$_lang['articles.setting.commentsDateFormat_desc'] = 'The format of the date to show for a comment\'s post date. The syntax is in PHP date() format.';
...
/* Settings */
$_lang['setting_articles.default_container_template'] = 'Standaard Artikel Container Template';
$_lang['setting_articles.default_container_template_desc'] = 'Het standaard Template voor het maken van een nieuwe Artikel Container';

$_lang['setting_articles.default_article_template'] = 'Standaard Artikel Template';
$_lang['setting_articles.default_article_template_desc'] = 'Het standaard Template voor het maken van een nieuw Artikel als er geen is toegekend aan de Container zelf.';

$_lang['setting_articles.container_ids'] = 'Artikel FURL IDs';
$_lang['setting_articles.container_ids_desc'] = 'Een komma-gescheiden lijst van container IDs in gebruik voor FURL routing. Alleen gebruiken als nodig.';

$_lang['setting_articles.default_article_sort_field'] = 'Standaard Sorteer Veld voor Artikelen in de Manager';
$_lang['setting_articles.default_article_sort_field_desc'] = 'Het standaard sorteer veld voor artikelen in het grid voor het wijzigen van een Container.';
